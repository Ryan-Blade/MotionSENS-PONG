...
imgBackground = cv2.imread(r"C:\Users\sulph\Desktop\Motion Game\1280x720-gaming-0yhvmfxag0yu5r34-ink.jpeg")
...
# Hand Detector
detector = HandDetector(detectionCon=0.1, maxHands=2) # comes with built-in library
...
mycursor.execute("CREATE TABLE IF NOT EXISTS profiles (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), scores INT(5))")
